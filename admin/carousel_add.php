...
include dirname(dirname(__FILE__)) . '/models/admin/CarouselModels.php';
...
$carouselModel = new CarouselModel($db);

if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    echo $twig->render('carousel_add.twig', [
        'user' => $_SESSION,
    ...
    // print_r($img);
    $carouselModel->addImage(
        $rank,
        $tagline,
        $link,
        $img
    );
    header('Location: carousel_index.php');
    die();
}
